...
function ScoreCardComponent({ data }: Props) {
  ...
  return (
    <section className="surface-panel card-lift rounded-3xl p-5">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="section-label">Quality Score</p>
          <p className="mt-2 text-sm text-slate-400">
            Backend-generated review confidence and risk signal.
          </p>
        </div>
      ...
      <div className="mt-6 flex items-end gap-3">
        <span className="score-value text-6xl font-semibold leading-none" style={{ color }}>
          {score.toFixed(1)}
        </span>
        <div className="pb-1">
      ...
      <div className="mt-5">
        ...
        <div className="h-3 rounded-full bg-slate-950/80 ring-1 ring-white/10">
          <div
      ...
      <div className="mt-5 grid grid-cols-3 gap-2">
        <div className="rounded-2xl border border-red-500/20 bg-red-500/10 px-3 py-2">
          ...
          <p className="mt-1 text-lg font-semibold text-white">{counts.critical}</p>
        </div>
        <div className="rounded-2xl border border-orange-500/20 bg-orange-500/10 px-3 py-2">
          <p className="text-xs text-orange-300">Major</p>
          <p className="mt-1 text-lg font-semibold text-white">{counts.major}</p>
        </div>
        <div className="rounded-2xl border border-yellow-400/20 bg-yellow-400/10 px-3 py-2">
          <p className="text-xs text-yellow-200">Minor</p>
          <p className="mt-1 text-lg font-semibold text-white">{counts.minor}</p>
        </div>
      </div>
      ...
      <div className="mt-5 rounded-2xl border border-white/10 bg-black/15 px-4 py-3">
        ...
        <div className="mt-2 flex items-center justify-between">
          <p className="text-sm text-slate-300">All structured issues</p>
